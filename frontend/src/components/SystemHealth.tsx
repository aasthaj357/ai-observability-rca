        ...
        {services.map((svc, idx) => (
          <div key={idx} className="flex items-center justify-between p-2 rounded-[6px] hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-[13px] font-medium text-gray-900 dark:text-gray-100">{svc.name}</span>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <span className="text-[12px] tabular-nums text-gray-500 dark:text-gray-400 w-[40px] text-right">
                {svc.latency}ms
              </span>
            </div>
          </div>
